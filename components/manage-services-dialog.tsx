    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Agrega o elimina servicios de streaming</DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          <form onSubmit={handleAddService} className="space-y-3">
            ...
            <div className="grid gap-2">
              <Label htmlFor="user-capacity">Capacidad de usuarios por defecto</Label>
              <Input
                id="user-capacity"
                type="number"
                min="1"
              ...
              <p className="text-xs text-muted-foreground">
                Número de usuarios que pueden usar esta cuenta simultáneamente
              </p>
            </div>
              ...
              {services.map((service) => (
                <div key={service.id} className="flex items-center justify-between p-2 border rounded-md">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Capacidad: {service.default_user_capacity} usuarios</p>
                  </div>
